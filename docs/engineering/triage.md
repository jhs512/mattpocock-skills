...
You invoke this by typing `/triage` and then describing what you want in plain language. "Show me anything that needs my attention", "let's look at #42", "move #42 to ready-for-agent".
